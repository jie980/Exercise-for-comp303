...
//		{
//
//			observer.sizeChanged(pCard);
//		}
	}
	
	public void addObservers(Observer pObserver) {
	...
	{
		assert !isEmpty();
		DrawnCard =  aCards.remove(aCards.size() - 1);
		//for(Observer observer : aObservers)
		//{
		//	observer.hasDrawn(DrawnCard);;
		//	observer.sizeChanged(aCards.size());
		//}
		for(Observer observer : aObservers)
		{
